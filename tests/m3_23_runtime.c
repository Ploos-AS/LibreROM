...
int main(int argc,char**argv){if(argc!=2)return 2;FILE*f=fopen(argv[1],"rb");if(!f)return 1;size_t n=fread(rom,1,sizeof rom,f);fclose(f);if(n!=sizeof rom)return 1;m68k_init();m68k_set_cpu_type(M68K_CPU_TYPE_68000);m68k_pulse_reset();unsigned cycles=0;while(cycles<2200000u&&r32(0x424)!=0x4f4b3232u){int x=m68k_execute(64);cycles+=(unsigned)(x>0?x:64);}printf("LibreROM M3.23 regression runtime evidence\ncycles=%u overlay=%d heap_next=%08x mem_err=%04x\n",cycles,overlay,r32(0x440),r16(0x220));printf("inherited markers: PS22=%08x PR22=%08x HS22=%08x HR22=%08x OK22=%08x\n",r32(0x404),r32(0x408),r32(0x410),r32(0x414),r32(0x424));if(overlay)return 1;if(r32(0x400)!=0x4d333232u||r32(0x404)!=0x50533232u||r32(0x408)!=0x50523232u||r32(0x410)!=0x48533232u||r32(0x414)!=0x48523232u||r32(0x418)!=0x46423232u||r32(0x424)!=0x4f4b3232u)return 1;if(r16(0x220)!=0u)return 1;puts("LibreROM M3.23 inherited M3.22 runtime regression: PASS");return 0;}
