...
int main(int argc,char**argv){if(argc!=2)return 2;FILE*f=fopen(argv[1],"rb");if(!f)return 1;size_t n=fread(rom,1,sizeof rom,f);fclose(f);if(n!=sizeof rom)return 1;m68k_init();m68k_set_cpu_type(M68K_CPU_TYPE_68000);m68k_pulse_reset();unsigned cycles=0;while(cycles<1200000u&&r32(0x424)!=0x4f4b3135u){int x=m68k_execute(64);cycles+=(unsigned)(x>0?x:64);}printf("LibreROM M3.15 runtime evidence\ncycles=%u overlay=%d heap_next=%08x mem_err=%04x\n",cycles,overlay,r32(0x440),r16(0x220));printf("master0=%08x master1=%08x master2=%08x master3=%08x ptr=%08x\n",r32(0x7000),r32(0x7004),r32(0x7008),r32(0x700c),r32(0x7ff00));if(overlay)return 1;if(r32(0x400)!=0x4d333135u||r32(0x40c)!=0x484f3135u||r32(0x410)!=0x43503135u||r32(0x414)!=0x50423135u||r32(0x418)!=0x504c3135u||r32(0x41c)!=0x4b503135u||r32(0x424)!=0x4f4b3135u)return 1;if(r32(0x440)!=0x00080000u||r16(0x220)!=0u)return 1;if(r32(0x7000)!=0x00010000u||r32(0x7004)!=0x0007ffe0u||r32(0x7008)!=0x0007ff20u||r32(0x700c)!=0x0007ff40u)return 1;if(r32(0x7ff00)!=0x50543135u||r32(0x7ff20)!=0x42323135u||r32(0x7ff40)!=0x43333135u||r32(0x7ffdc)!=0x43543135u)return 1;puts("LibreROM M3.15 mixed Ptr/Handle compaction runtime qualification: PASS");return 0;}
