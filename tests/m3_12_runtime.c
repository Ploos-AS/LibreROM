...
int main(int argc,char**argv){if(argc!=2)return 2;FILE*f=fopen(argv[1],"rb");if(!f)return 1;size_t n=fread(rom,1,sizeof rom,f);fclose(f);if(n!=sizeof rom)return 1;m68k_init();m68k_set_cpu_type(M68K_CPU_TYPE_68000);m68k_pulse_reset();unsigned cycles=0;while(cycles<900000u&&r32(0x424)!=0x4f4b3132u){int x=m68k_execute(64);cycles+=(unsigned)(x>0?x:64);}printf("LibreROM M3.12 runtime evidence\ncycles=%u overlay=%d heap_next=%08x mem_err=%04x\n",cycles,overlay,r32(0x440),r16(0x220));printf("master0=%08x master1=%08x master2=%08x\n",r32(0x7000),r32(0x7004),r32(0x7008));if(overlay)return 1;if(r32(0x400)!=0x4d333132u||r32(0x40c)!=0x4c503132u||r32(0x410)!=0x424c3132u||r32(0x414)!=0x554c3132u||r32(0x418)!=0x4b50314fu||r32(0x424)!=0x4f4b3132u)return 1;if(r32(0x440)!=0x00010060u||r16(0x220)!=0u)return 1;if(r32(0x7000)!=0x00010000u||r32(0x7004)!=0u||r32(0x7008)!=0x00010020u)return 1;puts("LibreROM M3.12 locked-purge pressure runtime qualification: PASS");return 0;}
