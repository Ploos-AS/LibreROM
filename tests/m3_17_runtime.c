...
int main(int argc,char**argv){if(argc!=2)return 2;FILE*f=fopen(argv[1],"rb");if(!f)return 1;size_t n=fread(rom,1,sizeof rom,f);fclose(f);if(n!=sizeof rom)return 1;m68k_init();m68k_set_cpu_type(M68K_CPU_TYPE_68000);m68k_pulse_reset();unsigned cycles=0;while(cycles<1200000u&&r32(0x424)!=0x4f4b3137u){int x=m68k_execute(64);cycles+=(unsigned)(x>0?x:64);}printf("LibreROM M3.17 runtime evidence\ncycles=%u overlay=%d heap_next=%08x mem_err=%04x\n",cycles,overlay,r32(0x440),r16(0x220));printf("master0=%08x master1=%08x tail_payload=%08x\n",r32(0x7000),r32(0x7004),r32(0x7ff00));if(overlay)return 1;if(r32(0x400)!=0x4d333137u||r32(0x40c)!=0x464c3137u||r32(0x410)!=0x48313137u||r32(0x414)!=0x434f3137u||r32(0x418)!=0x52453137u||r32(0x41c)!=0x4b503137u||r32(0x424)!=0x4f4b3137u)return 1;if(r32(0x440)!=0x00080000u||r16(0x220)!=0u)return 1;if(r32(0x7000)!=0x00010000u||r32(0x7004)!=0x0007ff00u)return 1;if(r32(0x7ff00)!=0x4e483137u)return 1;puts("LibreROM M3.17 inactive Ptr tail coalescing runtime qualification: PASS");return 0;}
